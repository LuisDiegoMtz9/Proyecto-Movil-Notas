...
import kotlinx.android.synthetic.main.fragmento_crear_notas.*
...
class FragmentoCrearNotas : FragmentoBase(),EasyPermissions.PermissionCallbacks,EasyPermissions.RationaleCallbacks{
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragmento_crear_notas, container, false)
    }

    companion object {
        @JvmStatic
        fun newInstance() =
            FragmentoCrearNotas().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnOk.setOnClickListener {
            if (etWebLink.text.toString().trim().isNotEmpty()){
                ...
                Toast.makeText(requireContext(),"Ingresa una Url",Toast.LENGTH_SHORT).show()
            }
        }
